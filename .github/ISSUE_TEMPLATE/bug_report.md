...
- **Tao's Folding Map Rewrite:** `4.x.x` [e.g. 4.0.0 stable, commit hash]
<!-- Make sure to reproduce the issue with only CBA and Tao's Folding Map Rewrite on a newly created mission! -->

**Description:**
A clear and concise description of what the bug is.

**Steps to reproduce:**
_Follow [this flowchart](https://ace3.acemod.org/img/wiki/user/issue_flowchart.webp) (Replace 'ACE3' with 'Tao's Folding Map Rewrite', ignore any 'Slack' mentions)!_
