...
/*
 * Author: johnb43
 * Opens foldmap for the centered tracking mode and monitors it until receiving a signal to close (GVAR(doShow) == false).
 *
 * Arguments:
 * None
 *
 ...
 *
 * Example:
 * call tao_rewrite_main_fnc_PFHcentered;
 *
 * Public: No
 */
...
[{
    ...
    // Update position to player's current position
